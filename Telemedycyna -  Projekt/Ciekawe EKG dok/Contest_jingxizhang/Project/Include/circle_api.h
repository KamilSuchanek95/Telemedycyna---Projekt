...
extern enum eSpeed
   {
   SPEED_LOW       = 0,                                  /*!< Low speed.      */
   SPEED_VERY_LOW  = 1,                                  /*!< Very low speed. */
   SPEED_MEDIUM    = 2,                                  /*!< Medium speed.   */
   SPEED_HIGH      = 3,                                  /*!< High speed.     */
   SPEED_VERY_HIGH = 4                                   /*!< Very high speed.*/
   } CurrentSpeed;
...
typedef struct
   ...
   s16 Shocked;                  /*!< 1 if MEMS shocked, otherwise 0.         */
...
#define MEMS_GetRotation(a,b)             ((tCircleFunc2)(Circle_API [MEMS_GET_ROTATION_ID])) ((u32)(a),(u32)(b))      //  void MEMS_GetRotation(Rotate_H12_V_Match_TypeDef * H12);
